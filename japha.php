...
class Japha
{
    ...
    */
    ...
    public static function getQualified( $resolved )
    {
...
class JaphaNamespace
{
    ...
    /**
     * An associative array that contains int => name pairs
    ...
    public function add( $name, $value )
    {
        ...
        $this->namespace[ ( int ) $name ] = ( string ) $value;
    }
    ...
    {
        return isset( $this->namespace[ ( int ) $name ] );   
    }
